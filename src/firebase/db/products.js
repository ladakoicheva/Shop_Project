...
//!учесть что при удалении продукта он так же должен удаляться из избранного 
//! при редактировании продукта так же должны обновляться данные 

// Избранные продукты  хранить в сторе 
//  доступно только авторизированным пользователям 

//в productCard:
// Создать отдельную переменную где проверяется есть ли продукт в избранном(true / false)

// Исходя из того true или false показывать соответствующую иконку
// И по клику вызывать соответствующую функцию add или delete



//   Запрос на бек(setDoc, Путь: user / uid / favourites / productId)
...
//сделать страничку профиля пользователя 
//информация по юзеру имя,имейл (можно добавить возможность загрузить аватарку)
//менюшка(сайдбар) профиль сеттинг и избранное
//в избранном отрисовать карточки и при клике переход на страничку продукта
